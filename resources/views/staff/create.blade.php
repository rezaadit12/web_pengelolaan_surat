...
@section('content')
<h2 class="mb-3">Tambah Data Staff Tata Usaha</h2>
...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">Tambah Data Staff Tata Usaha</li>
...
<form action="{{ route('staff.store') }}" method="POST" class="card p-5">
    ...
    {{-- <input type="hidden" class="form-control" id="role" name="role" value="guru"> --}}
